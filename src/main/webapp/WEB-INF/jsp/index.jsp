...
<html lang="zh-CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   ...
   <!-- 上述3个meta标签*必须*放在最前面，任何其他内容都*必须*跟随其后速度！ -->
    ...
    <!-- Bootstrap core CSS -->
    <link href="/openview/bootstrapfiles/bootstrap.min.css" rel="stylesheet">
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <link href="/openview/bootstrapfiles/ie10-viewport-bug-workaround.css" rel="stylesheet">

    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
    <script src="/openview/bootstrapfiles/ie-emulation-modes-warning.js"></script>
    ...
    <link href="/openview/bootstrapfiles/carousel.css" rel="stylesheet">
  </head>
<!-- NAVBAR
================================================== -->
  <body>
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">,
              <ul class="nav navbar-nav">
                ...
                <li><a href="javascript:void 0about">About</a></li>
                <li><a href="javascript:void 0contact">Contact</a></li>
                <li class="dropdown">
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="javascript:void 0" role="button">Learn more</a></p>
            </div>
          </div>
        </div>
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
              <p><a class="btn btn-lg btn-primary" href="javascript:void 0" role="button">Browse gallery</a></p>
            </div>
          </div>
        </div>
      </div>
      <a class="left carousel-control" href="javascript:void 0myCarousel" role="button" data-slide="prev">
        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
      </a>
      <a class="right carousel-control" href="javascript:void 0myCarousel" role="button" data-slide="next">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-default" href="javascript:void 0" role="button">View details Â»</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140">
          <h2>Heading</h2>
      ...
      <!-- FOOTER -->
      <footer>
        <p class="pull-right"><a class="go-top">Back to top<i class="fa fa-angle-up"></i></a></p>
        <span class="pull-right" id="nowTime"></span>
        <p>Â© 2016 Company, Inc. Â· <a href="javascript:void 0">Privacy</a> Â· <a href="javascript:void 0">Terms</a></p>
    ...
    <script src="/openview/bootstrapfiles/jquery.min.js"></script>
    <script>window.jQuery || document.write('<script src="/openview/bootstrapfiles/jquery.min.js"><//script>')</script><script src="/openview/bootstrapfiles/jquery.min.js"></script>
    <script src="/openview/bootstrapfiles/bootstrap.min.js"></script>
    <!-- Just to make our placeholder images work. Don't actually copy the next line! -->
    <script src="/openview/bootstrapfiles/holder.min.js"></script>
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="/openview/bootstrapfiles/ie10-viewport-bug-workaround.js"></script>
